...
#define SERVER_ADDR @"app.beswaggy.com"
#define SERVER_URL [NSString stringWithFormat:@"http://%@:8080/", SERVER_ADDR]
...
#pragma mark ---Текстовое поле из одной картинки в которое нельзя вставить текст---

+ (CBTNoPasteTextField *)noPasteTextFieldWithImageNamed:(NSString *)imageName margin:(float)leftMargin fontName:(NSString *)fontName fontSize:(float)fontSize fontColor:(NSString *)fontColor andPlaceholder:(NSString *)placeholder;
...
#pragma mark ---Текстовое поле из трех картинок в которое нельзя вставить текст---

/**
 Creates new CBTNoPasteTextField with no paste or edit functionality with a set of given params with three custom images as a background
 
 @param width @c controls the width of the input field
 @param leftMargin @c float value of a left input margin
 @param fontName @c NSString value of a font name
 @param fontSize @c CGSize value of UITextField's font size
 @return A newly created CBTNoPasteTextField with right set parametrs with a background image out of three images with a correct @c CGSize
 */
+ (CBTNoPasteTextField *)textFieldNoPasteWithLeftImageNamed:(NSString *)leftImageName middleImageNamed:(NSString *)middleImageName rightImageNamed:(NSString *)rightImageName fieldWidth:(float)width margin:(float)leftMargin fontName:(NSString *)fontName fontSize:(float)fontSize fontColor:(NSString *)fontColor andPlaceholder:(NSString *)placeholder;
